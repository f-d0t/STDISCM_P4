...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_UPLOADGRADERESPONSE']._serialized_end=617
  _globals['_ENROLLMENTSERVICE']._serialized_start=620
  _globals['_ENROLLMENTSERVICE']._serialized_end=861
